...
<head>
  ...
  <link rel="stylesheet" href="./font/arrowfont/iconfont.css">
...
<body>
  ...
  <div class="container">
    ...
    <div class="content-wrap">
      <div class="info">
        ...
        <span>集团总部招商热线: </span>
        <a href="tel:0755-56566573" class="telephone">0755-56566573</a>
        <p>
          <strong>地址:</strong><br />
        ...
        <form action="">
          <div class="row-container gutter-16">
            <div class="row-wrap">
              ...
              <div class="col-item-4">
                <img src="./images/contact001.png" alt="验证码">
              </div>
            </div>
          </div>
      ...
      <section>
        ...
        <div class="content">
          ...
          <div class="info">
            ...
            <span>座机：<a href="tel:0755-86566573转6019">0755-86566573转6019</a></span>
          </div>
        </div>
      </section>
      <section>
  ...
  <div class="container">
    <div class="pagination shop-module padding-top-40">
  ...
  <!-- <script type="text/javascript">
    ...
    function createMap(){
      ...
      map.centerAndZoom(new BMap.Point(113.961119,22.543936),19);
    }
    ...
    function addMapOverlay(){
      var markers = [
        {content:"电话: ",title:"富诚科技大厦",imageOffset: {width:0,height:3},position:{lat:22.544378,lng:113.960944}}
      ];
